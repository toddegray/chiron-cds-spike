...
public class NoteEntryRendererTests
{
    ...
    {
        var html = NoteEntryRenderer.Render(View(), Hdr);
        ...
        html.Should().Contain("class=\"tab active\" href=\"/app/patient/p1/notes\"", because: "the Notes tab is active");
    }
    ...
    public void Form_Echoes_Submitted_Draft_Across_Renders()
    {
        ...
        var html = NoteEntryRenderer.Render(View(draft: draft), Hdr);
    ...
    public void History_List_Renders_Prior_Notes_With_Status_Pills()
    {
        ...
        var html = NoteEntryRenderer.Render(View(history: history), Hdr);
    ...
    {
        var html = NoteEntryRenderer.Render(View(chartError: "Timed out"), Hdr);
    ...
    {
        var html = NoteEntryRenderer.Render(View(NoteEntryStatus.NotAuthorised), Hdr);
    ...
    public void Renderer_Html_Encodes_Hostile_Strings()
    {
        ...
        var html = NoteEntryRenderer.Render(View(draft: draft, history: history), Hdr);
