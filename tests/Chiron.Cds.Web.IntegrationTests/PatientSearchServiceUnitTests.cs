...
public class PatientSearchServiceUnitTests
{
    ...
    public void ToHit_Uses_Text_When_Present()
    {
        ...
        var hit = PatientSearchService.ToHit(p, mrnSystem: null);
    ...
    public void ToHit_Composes_Family_And_Given_When_Text_Missing()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).DisplayName.Should().Be("Doe, John Q.");
    }
    ...
    public void ToHit_Uses_Family_Only_When_Given_Missing()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).DisplayName.Should().Be("Cher");
    }
    ...
    public void ToHit_Uses_Given_Only_When_Family_Missing()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).DisplayName.Should().Be("Madonna");
    }
    ...
    public void ToHit_Falls_Back_To_Patient_Id_When_Name_Empty()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).DisplayName.Should().Be("Patient id5");
    }
    ...
    public void ToHit_Falls_Back_When_Name_Entry_Has_Only_Empty_Fields()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).DisplayName.Should().Be("Patient id6");
    }
    ...
    public void ToHit_Captures_Gender_When_Present()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).Gender.Should().Be("Female");
    }
    ...
    public void ToHit_Gender_Is_Empty_String_When_Null()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).Gender.Should().BeEmpty();
    }
    ...
    public void ToHit_Captures_BirthDate_When_Present()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).BirthDate.Should().Be("1980-06-15");
    }
    ...
    public void ToHit_BirthDate_Is_Empty_String_When_Null()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).BirthDate.Should().BeEmpty();
    }
    ...
    public void ToHit_PatientId_Is_Empty_String_When_Resource_Has_No_Id()
    {
        ...
        PatientSearchService.ToHit(p, mrnSystem: null).PatientId.Should().BeEmpty();
    }

    [Fact]
    public void ToHit_Includes_Mrn_From_Configured_System()
    {
        var p = new Patient
        {
            Id = "fhir-id",
            Identifier = { new Identifier("urn:oid:mrn", "203713") },
        };
        PatientSearchService.ToHit(p, mrnSystem: "urn:oid:mrn").Mrn.Should().Be("203713",
            because: "the search row shows the MRN, not the opaque FHIR id");
    }
}
