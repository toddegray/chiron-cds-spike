...
public class EncounterCloseRendererTests
{
    ...
    private static readonly IReadOnlyList<ChartTab> Tabs = new[]
    {
        ...
        new ChartTab("Sign off", "/app/patient/p1/signoff", IsActive: true),
    };
    ...
    {
        var html = EncounterCloseRenderer.Render(View(), NavBar, Tabs);
    ...
    public void In_Progress_Encounter_Renders_With_Close_Button()
    {
        ...
        var html = EncounterCloseRenderer.Render(View(encounters: new[] { e }), NavBar, Tabs);
    ...
    public void ClosedOk_Status_Renders_Success_Banner_And_Next_Patient_Link()
    {
        var html = EncounterCloseRenderer.Render(
            View(SignOffStatus.ClosedOk, writtenId: "e1"), NavBar, Tabs);
    ...
    {
        var html = EncounterCloseRenderer.Render(View(SignOffStatus.NotAuthorised), NavBar, Tabs);
